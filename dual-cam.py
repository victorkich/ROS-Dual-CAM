...
bridge = CvBridge()
defisheye = Defisheye(dtype='linear', format='fullframe', fov=80, pfov=140)
...
pub_image = rospy.Publisher('/usb_cam/image_raw', Image, queue_size=30)
...
while rval1 and rval2:
    ...
    rval1, frame1 = cam1.read()
    rval2, frame2 = cam2.read()
    frame1 = defisheye.convert(frame1)
    frame2 = defisheye.convert(frame2)
