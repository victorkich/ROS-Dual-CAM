...
class RealTtb:
    ...
    def get_angle_distance(self, state, lidar, green_magnitude=1.0):
        ...
        # green Yellow triangulated Points
        ...
        # if leftPoint: # NAO SEI
        #     cv2.circle(frame, leftPoint, 5, (0, 0, 250), -1)
        # if rightPoint: # vermelho
        #     cv2.circle(frame, rightPoint, 5, (0, 0, 0), -1)
        # if aimPoint:
        ...
        if leftPoint and rightPoint and aimPoint and green1 and green2:
            midPoint = mid_point(leftPoint, rightPoint)
