...
class TestLocal:
    def __init__(self):
        ...
        rospy.Subscriber('/usb_cam/image_right/compressed', CompressedImage,  self.image_right_callback, tcp_nodelay=True, queue_size=1, buff_size=2**26)
        rospy.Subscriber('/usb_cam/image_left/compressed', CompressedImage, self.image_left_callback, tcp_nodelay=True, queue_size=1, buff_size=2**26)
