...
class TestLocal:
    def __init__(self):
        ...
        rospy.Subscriber('/usb_cam/compressed/image_right', CompressedImage,  self.image_right_callback, buff_size=100, tcp_nodelay=True, queue_size=1)
        rospy.Subscriber('/usb_cam/compressed/image_left', CompressedImage, self.image_left_callback, buff_size=100, tcp_nodelay=True, queue_size=1)
