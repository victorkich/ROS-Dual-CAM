...
bridge = CvBridge()
pub_image = rospy.Publisher('/usb_cam/compressed/image_left', CompressedImage, queue_size=None)
pub_image2 = rospy.Publisher('/usb_cam/compressed/image_right', CompressedImage, queue_size=None)
