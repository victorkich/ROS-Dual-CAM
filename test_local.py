...
class TestLocal:
    def __init__(self):
        ...
        rospy.Subscriber('/usb_cam/compressed/image_right', CompressedImage,  self.image_right_callback, tcp_nodelay=True, queue_size=30)
        rospy.Subscriber('/usb_cam/compressed/image_left', CompressedImage, self.image_left_callback, tcp_nodelay=True, queue_size=30)
